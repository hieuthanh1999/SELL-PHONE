              ...
              @foreach($orders as $order)
                <tr>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <a style="margin-left: 5px;" href="{{ route('admin.order.show', ['id' => $order->id]) }}" class="btn btn-icon btn-sm btn-primary tip" title="Chi Tiết">
  ...
  $(function () {
    var table = $('#order-table').DataTable({
      ...
      "lengthChange": false,
       "autoWidth": false,
       "order": [],
      "dom": '<""t><<"row"<"col-md-6 col-sm-6"i><"col-md-6 col-sm-6"p>>>',
