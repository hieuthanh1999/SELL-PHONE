      ...
      <div class="invoice-info">
        <div class="row">
          <div class="col-md-3 col-sm-3 col-xs-3">
            ...
            <address>
              <b>Admin VDO</b><br>
              Phone: (+84) 934 518 026<br>
              Email: dangminhduc21197@gmail.com<br>
              Address: Phú Diễn - Từ Liêm - Hà Nội.
            </address>
          </div>
          <div class="col-md-3 col-sm-3 col-xs-3">
            To: <br>
            ...
            <tbody>
              ...
              @foreach($order->order_details as $key => $order_detail)
                ...
                <tr>
                  ...
                  <td><span style="color: #009981;">{{ number_format($order_detail->price,0,',','.') }} VNĐ</span></td>
                  <td><span style="color: #009981;">{{ number_format($order_detail->price * $order_detail->quantity,0,',','.') }} VNĐ</span></td>
                </tr>
              @endforeach
              <tr>
                  <td colspan="7" style="text-align: right;"><b>Tổng = <span style="color: #009981;">{{ number_format($price,0,',','.') }} VNĐ</span></b></td>
              </tr>
            </tbody>
          </table>
        </div>
          ...
          <div class="table-responsive">
            <table class="table">
              <tr>
                ...
                <td><span style="color: #009981;">{{ number_format($price,0,',','.') }} VNĐ</span></td>
              </tr>
              <tr>
                <th>Đã Thanh Toán:</th>
                @if(Str::contains($order->payment_method->name, 'Online Payment'))
                <td><span style="color: #009981;">{{ number_format($price,0,',','.') }} VNĐ</span></td>
                @else
                <td><span style="color: #009981;">0 VNĐ</span></td>
                @endif
              </tr>
              {{-- <tr>
