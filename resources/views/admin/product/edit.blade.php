        ...
        <div class="box box-solid box-default collapsed-box" style="margin-bottom: 5px;">
          <div class="box-header">
            ...
            <div class="box-tools">
              ...
              <a href="javascript:void(0);" data-id="{{ $promotion->id }}" class="btn btn-box-tool remove-promotion" title="Xóa" data-url="{{ route('admin.product.delete_promotion') }}" style="color: #009981;">
        ...
        @if($product->product_details->isNotEmpty())
          ...
          <div class="box box-solid box-default collapsed-box" style="margin-bottom: 5px;">
            <div class="box-header">
              ...
              <div class="box-tools">
                <button class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse"><i class="fa fa-plus"></i></button>
                <a href="javascript:void(0);" data-id="{{ $product_detail->id }}" class="btn btn-box-tool remove-product-detail" title="Xóa" data-url="{{ route('admin.product.delete_product_detail') }}" style="color: #009981;">
                  <i class="fa fa-times"></i>
                </a>
              </div>
            </div>
