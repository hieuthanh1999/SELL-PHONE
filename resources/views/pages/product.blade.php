...
@section('content')
  ...
  <div class="site-product">
                  ...
                  <div class="price-product">
                    @foreach($data['product_details'] as $key => $product)
                      ...
                      @endif
                        ...
                        @else
                          <div class="status">Tình trạng: <span style="color: #009981;">Hết hàng</span></div>
                        @endif
                      </div>
                    @endforeach
                  </div>
    ...
    <section class="section-favorite-products">
      ...
      <div class="section-content">
        <div id="slide-cungloai" class="owl-carousel">
          @foreach($data['suggest_products2'] as $product)
              ...
              <a href="{{ route('product_page', ['id' => $product->id]) }}" title="{{ $product->name }}">
                ...
                <div class="content-product">
                  ...
                  <div class="info-compare">
                    <a class="button-compare" href="compare/{{$data['product']->id}}/{{$product->id}}"><i class="fas fa-exchange-alt"></i><span>So sánh</span></a>
                 </div>
                </div>
