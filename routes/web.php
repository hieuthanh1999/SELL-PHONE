...
->group(function() {
  ...
  Route::post('user/updateLevel/{id}', 'UserController@updateLevel')->name('users.updateLevel');
...
Route::namespace('Pages')->group(function () {
 ...
 // $url = route('home_page');
  ...
  Route::get('product/compare/{id}/{compareId}', 'ProductsController@compare')->name('compare');
